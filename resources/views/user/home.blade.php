                  ...
                  <div class="rounded">
                      <div class="relative">
                          ...
                          <a href="/detail/{{ $item->id }}">
                              <div
                                  class="absolute bottom-0 left-0 bg-black px-4 py-2 text-white text-sm hover:bg-white hover:text-indigo-600 transition duration-500 ease-in-out">
                                  Detail 
                              </div>
                          </a>
                      </div>
                      <div class="px-3 py-2">
                          <p class="font-semibold text-lg text-black inline-block hover:text-white transition duration-500 ease-in-out">
                                {{ $item->name }}
                          </p>
          ...
          <section class="bg-white">
              <div class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
                  ...
                  <p class="mt-8 text-base leading-6 text-center text-gray-400">
                      © 2024 Universiti Gajah Putih, Kab Aceh Tengah, Aceh, INDONESIA.
                  </p>
              </div>
          </section>
    </footer>
