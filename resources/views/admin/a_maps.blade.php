...
@section('isi')
    ...
    <section class="flex flex-row">
            ...
            @else
                @foreach ($daftar as $item)
                    <div style="width: 350px;" class="mt-2 h-30 border-2 border-gray-500 rounded-lg pr-1">
                        ...
                        <h2 class="text-xl font-bold ml-4">{{ $item->name }} </h2>
                        <div class="flex ml-3">
                        ...
                        <div class="flex ml-3">
                            <span class="ml-1  text-sm text-center">Kecamatan : {{ $item->sub_feature }}</span>
                        </div>
                        <div class="stat pt-0 mt-2 ml-0">
                            <div class="flex justify-end">
                                ...
                                {{-- <button data-lat="{{ $item->latitude }}" data-long={{ $item->longitude }}
                                            class="text-gray-700 border border-gray-700 btn-rute hover:bg-gray-700 hover:text-white active:bg-gray-700 font-bold uppercase text-xs px-4 py-2 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
        ...
        <div class="order-first md:order-last w-full md:w-2/3 md:ml-6 mt-10">
            <div>
                        ...
                        <div
                            ...
                            <div class="relative p-6 flex-auto">
                                <p class="my-4 text-slate-500 text-lg leading-relaxed">
                                    1. Determine your location by pressing the start button from your position or moving the
                                    blue marker on the map.<br>
                                    2. You can search for a destination by searching for the name of a tourist attraction,
                                    village, district or tourist category and pressing the route button to route from your
                                    location.<br>
                                    3. You can also click on the red marker, a pop up will appear, and press select here to
                                    route.<br>
                                    4. Finish <br>
                                </p>
                            </div>
                            <!--footer-->
                            <div class="flex items-center justify-end p-4 border-t border-solid border-slate-200 rounded-b">
            ...
            <div class="modal-box relative">
                ...
                <form action="/vote" method="post" class="ml-10">
                    ...
                    <div class="w-full mt-10">
                        <input type="range" min="1" max="5" value="1" class="range" step="1"
                            name="skor" />
                        <div class="w-full flex justify-between text-xs px-2">
                            <span>1 <br>
                                <p class="mt-1">Buruk</p>
                            </span>
                            <span>2</span>
                            <span>3</span>
                            <span>4</span>
                            <span>5 <br>
                                <p class="mt-1">Bagus</p>
                            </span>
                        </div>
                    </div>
                    <div class="flex justify-center">
                        <div class="flex mb-10 mt-16">
                            <button
                                class="bg-green-500 text-gray-100 font-bold  border-b-2 rounded-full border-green-500 hover:border-green-700 hover:text-white shadow-md py-2 px-6 inline-flex items-center">
    ...
    <script type="text/javascript">
        ...
        var osmHOT = L.tileLayer('https://{s}.tile.opentopomap.org/{z}/{x}/{y}.png', {
        ...
        var mymap = L.map('mapid', {
            center: [4.613042410908224, 96.92072810504004],
            zoom: 13,
            layers: [satelit]
        });
    ...
    <div class="flex ml-2">
        <span class="ml-1 text-sm"> Desa : ${response.location}</span>
    </div>
    <div class="flex  ml-2">
