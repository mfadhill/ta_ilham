...
<form action="/a_daftar/{{ $daftar->id }}/" method="POST" enctype="multipart/form-data" class="ml-10">
    ...
    <div class="grid sm:grid-cols-1 lg:grid-cols-2 gap-1 ml-10 mt-2">
        ...
        <div class="md:grid-cols-1">
            <label class="label">
                <span class=" label-text ml-2 font-bold"> Location <span style="color:red"> &#x26B9;</span> </span>
            </label>
        ...
        <div class="md:grid-cols-1">
            ...
            <select name="feature" id="feature" class="select max-w-xs select-accent w-80">
        ...
        <div class="md:grid-cols-1">
            <label class="label mt-4 ">
                <span class="label-text ml-2 font-bold">Sub Feature <span style="color:red"> &#x26B9;</span></span>
            </label>
        ...
        <div class="md:grid-cols-1">
            ...
            <input type="text" placeholder="Elevation" id="elevation" name="elevation"
                class="input input-bordered input-accent w-80 @error('elevation') is-invalid @enderror"
             value="{{ $daftar->elevation }} ">
            @error('elevation')
                <div>
                    <label class="text-red-700">{{ $message }}</label>
                </div>
      ...
      <div class="md:grid-cols-1">
        <label class="label mt-4">
         ...
         <textarea name="deskrip" id="deskrip" cols="30" rows="10" class="input input-bordered input-accent h-40 w-80" @error('deskrip') is-invalid @enderror value="{{ $daftar->deskrip }}">{{ $daftar->deskrip }}</textarea>
        @error('deskrip')
            <div>
                <label class="text-red-700">{{ $message }}</label>
            </div>
      ...
      <div class="mt-8 hidden">
        ...
        <div class="border border-dashed border-black relative mt-14 w-80 h-32">
            <label for="img" class="form-label inline-block mb-2 text-black"> Upload More Picture  : </label>
        ...
        <div class="">
            <div class="mb-3 w-60">
                <label for="img" class="form-label inline-block mb-2 text-gray-700"> Choice Picture <span style="color:red"> &#x26B9;</span></label>
